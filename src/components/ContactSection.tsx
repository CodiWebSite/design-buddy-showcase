      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="card-professional rounded-xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@webcraft.ro" className="text-foreground hover:text-primary transition-colors font-medium">
                      contact@webcraft.ro
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+40721234567" className="text-foreground hover:text-primary transition-colors font-medium">
                      +40 721 234 567
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-foreground font-medium">București, România</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-professional rounded-xl p-8">
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <div className="flex justify-between">
                  <span>Duminică</span>
                  <span className="text-foreground font-medium">Închis</span>
                </div>
              </div>
            </div>
          </div>
