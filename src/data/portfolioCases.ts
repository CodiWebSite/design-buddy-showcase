...
export const portfolioCases: PortfolioCase[] = [
  ...
  },
  {
    slug: "romartos",
    title: "Romartos",
    business: "Icoane ortodoxe pictate manual",
    url: "https://romartos.ro/",
    image: screenshot("https://romartos.ro/"),
    tags: ["Galerie", "Catalog", "Comandă la cerere"],
    challenge:
      "Avea nevoie de o vitrină online care să prezinte cu respect icoanele pictate manual și să primească comenzi.",
    solution:
      "Site cu galerie de icoane, pagini individuale detaliate și cerere de ofertă directă pe WhatsApp.",
    detailedChallenge:
      "Iconar cu icoane bizantine pictate integral manual (tempera cu ou, foiță de aur), fără o platformă unde să-și prezinte lucrările la calitatea pe care o merită. Clienții credincioși căutau online, dar nu găseau o galerie serioasă cu detalii despre tehnică, dimensiuni și posibilitatea de comandă personalizată.",
    detailedSolution: [
      "Design sobru, cu accent pe fotografiile icoanelor și pe detaliile de foiță de aur.",
      "Pagină individuală pentru fiecare icoană cu dimensiuni, tehnică, sfânt reprezentat și descriere.",
      "Cerere ofertă directă pe WhatsApp cu mesaj pre-completat pentru fiecare icoană.",
      "Posibilitatea de a comanda icoane personalizate (sfânt patron, dimensiune, dedicație).",
      "SEO pentru căutări de tip 'icoane pictate manual', 'icoane bizantine', 'icoană sfânt patron'.",
    ],
    results: [
      { label: "Comenzi lunare", value: "+220%" },
      { label: "Trafic organic", value: "+280%" },
      { label: "Scor PageSpeed", value: "93" },
      { label: "Poziție Google", value: "Top 5" },
    ],
    technologies: ["React", "Tailwind CSS", "Schema.org", "WhatsApp API"],
    duration: "4 săptămâni",
  },
  {
    slug: "portidinlemn",
    title: "Porți din Lemn",
    business: "Porți tradiționale românești",
    url: "https://portidinlemn.ro/",
    image: screenshot("https://portidinlemn.ro/"),
    tags: ["Portofoliu", "Meșteșug", "Autentic"],
    challenge:
      "Voia un site care să transmită autenticitatea meșteșugului românesc și să aducă cereri serioase pentru porți la comandă.",
    solution:
      "Site cu identitate tradițională puternică, portofoliu de porți realizate și cerere ofertă directă pe WhatsApp.",
    detailedChallenge:
      "Meșter care construiește porți din lemn masiv/stejar cu structură de beton armat și placaj din piatră — lucrări trainice, tradiționale, cu o identitate românească puternică. Fără prezență online, clienții veneau doar din zonă și din recomandări, deși produsul se preta la comenzi din toată țara.",
    detailedSolution: [
      "Ton editorial autentic, românesc — textele păstrează vocea meșterului, nu marketing-speak.",
      "Portofoliu de modele realizate cu detalii despre materiale (lemn masiv, stejar, piatră, cadru metalic).",
      "Secțiune despre procesul de execuție: structură, îmbinare lemn-piatră, durabilitate.",
      "CTA principal pe WhatsApp cu mesaj pre-completat pentru cerere ofertă.",
      "SEO pe cuvinte cu intenție clară: 'porți din lemn masiv', 'porți tradiționale românești', 'porți stejar la comandă'.",
    ],
    results: [
